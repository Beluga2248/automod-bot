...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const status = (flag) => flag ? '</Yes:1011614293420150805> Enabled' : '<a:Wrong:1017416697168269372:> Disabled';

    const embed = new EmbedBuilder()
      .setTitle(`</Moderation:1115208500172292127> Automod Status for ${interaction.guild.name}`)
      .setColor('Blue')
      .addFields(
